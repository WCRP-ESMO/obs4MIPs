...
summary: Recipe from obs4mips cmor tables
sidebar_title: inputs examples
---

From [inputs folder](https://github.com/WCRP-ESMO/obs4MIPs-cmor-tables/tree/master/inputs)
